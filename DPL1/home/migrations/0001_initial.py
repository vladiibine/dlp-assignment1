...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'home_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Page'])),
        ...
        db.send_create_signal(u'home', ['Question'])

        # Adding model 'Answer'
        db.create_table(u'home_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Question'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('points', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'home', ['Answer'])
    ...
    def backwards(self, orm):
        # Deleting model 'Test'
        db.delete_table(u'home_test')

        # Deleting model 'Page'
        db.delete_table(u'home_page')

        # Deleting model 'Question'
        db.delete_table(u'home_question')

        # Deleting model 'Answer'
        db.delete_table(u'home_answer')
